# paw_ansible_role_pip
# @summary Manage paw_ansible_role_pip configuration
#
# @param pip_package For Python 3, use python3-pip.
# @param pip_executable
# @param pip_install_packages
...
class paw_ansible_role_pip (
  String $pip_package = 'python3-pip',
  String $pip_executable = '{{ \'pip3\' if pip_package.startswith(\'python3\') else \'pip\' }}',
  Array $pip_install_packages = [],
...
# Execute the Ansible role using PAR (Puppet Ansible Runner)
  ...
  $playbook_path = "${vardir}/lib/puppet_x/ansible_modules/ansible_role_pip/playbook.yml"
